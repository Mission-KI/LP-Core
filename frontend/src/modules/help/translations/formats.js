const formatsHelpText = {
    ...
    de: {
        fullContent:
            `
                <div class="col-md-10">
                <h4 class="bold mb-5">Unterstützte Datenformate</h4>
                ...
                <h4 class="bold mb-5">Datenstrukturen</h4>
                ...
                <h4 class="bold mb-5">Analysen</h4>
                ...
                <h5 class="bold mb-5">Generelle Analysen für alle Datenformate</h5>
                <h6 class="bold mb-5" id="asset-properties-general">Asset Eigenschaften</h6>
                <h7 class="bold mt-3 mb-3" id="open-access-section">Open Access</h7>
                Dieses Icon zeigt an, dass auf ein Asset ohne Registrierung über die EDP-Data Source zugegriffen werden kann. 
                <h7 class="bold mt-3 mb-3" id="closed-access-section">Closed Access</h7>
                Dieses Icon zeigt an, dass auf ein Asset nur nach Registrierung über die EDP-Data Source zugegriffen werden kann. 
                <h7 class="bold mt-3 mb-3" id="asset-processing-status-section">Asset Verarbeitungszustand</h7>
                ...
                <h7 class="bold mt-3 mb-3">Versionsangaben</h7>
                ...
                <h7 class="bold mt-3 mb-3"Datenformat-spezifische Asset Eigenschaften</h7>
                ...
                <h6 class="bold mb-5" id="data-science-info-general">Bereich Data Science Info</h6>
                <h7 class="bold mt-3 mb-3">Datenformat</h7>
                Hier wird das Datenformat des EDP bzw. bei geschachtelten Strukturen des ausgewählten Elements angezeigt.
                <h7 class="bold mt-3 mb-3">Dateityp</h7>
                Neben der Kategorisierung des Datenformats wird auch der eigentliche Dateityp angezeigt.
                <h7 class="bold mt-3 mb-3">Volumen</h7>
                Angezeigt wird hier die Größe des Assets bei der Verarbeitung. Bei Archiven handelt es sich somit um die komprimierte Größe. 
                <h7 class="bold mt-3 mb-3">Sprachen</h7>
                Das Asset wird auf die darin enthaltenen Sprachen geprüft. 
                <h7 class="bold mt-3 mb-3">Übertragungsart</h7>
                Unterschieden wird hier zwischen statischen (“static”) und inflationären Daten (“inflationary“). 
                <h7 class="bold mt-3 mb-3">Unveränderlichkeit</h7>
                Hierbei handelt es sich um die semantische Information, ob damit gerechnet werden kann, dass der Datensatz in Zukunft geändert werden wird (“mutable”) oder nicht (“immutable”). 
                <h7 class="bold mt-3 mb-3">Datenformat-spezifische Angaben in der Data Science Info</h7>
                Für die folgenden Datenformate gibt es zusätzliche Angaben in der Data Science Info:
                <ul>
                ...
                <h5 class="bold mb-5">Zusätzliche Analysen für Archive</h5>
                <h6 class="bold mb-5" id="data-science-info-archive">Bereich Data Science Info</h6>
                <h7 class="bold mt-3 mb-3">Komprimierung</h7>
                Hier wird der zur Komprimierung angewendete Algorithmus angezeigt.
                <h7 class="bold mt-3 mb-3">Unkomprimiertes Volumen</h7>
                Als Ergänzung zum weiter oben angezeigten Volumen, das die komprimierte Größe anzeigt, ist an dieser Stelle die Größe des entpackten Archivs sichtbar.
                <h6 class="bold mb-5">Tab: Asset Struktur</h6>
                ...
                <h5 class="bold mb-5">Zusätzliche Analysen für Dokumente</h5>
                <h6 class="bold mb-5">Tab: Dokument</h6>
                ...
                <h6 class="bold mb-5">Tab: Eingebettete Tabellen</h6>
                Falls vorhanden, bietet dieser Tab weitere Details zu den im Dokument enthaltenen Tabellen.
                <h6 class="bold mb-5">Tab: Eingebettete Bilder</h6>
                Falls vorhanden, bietet dieser Tab weitere Details zu den im Dokument enthaltenen Bildern (Daten analog zu [<a href="/help#tab-image">Datentyp Bilder -> Tab: Bild</a>).
                <h5 class="bold mb-5">Zusätzliche Analysen für strukturierte Daten</h5>
                <h6 class="bold mb-5" id="asset-properties-structured">Asset Eigenschaften</h6>
                <h7 class="bold mt-3 mb-3" id="date-time-attribute-section">Date Time Attribute</h7> 
                ...
                <h7 class="bold mt-3 mb-3" id="temporal-frequency-section">Temporal Frequency</h7> 
                ...
                <h7 class="bold mt-3 mb-3" id="data-type-consistency-section">Data Type Consistency</h7> 
                ...
                <h7 class="bold mt-3 mb-3" id="attribute-integrity-section">Attribute Integrity</h7> 
                ...
                <h7 class="bold mt-3 mb-3" id="significant-variance-section">Significant Variance</h7> 
                ...
                <h7 class="bold mt-3 mb-3" id="allowed-for-ai-section">Allowed for AI Training</h7> 
                ...
                <h6 class="bold mb-5" id="data-science-info-structured">Bereich Data Science Info</h6>
                Neben den generellen Angaben im Bereich Data Science Info für alle Datenformate, werden im Fall strukturierter Daten noch weitere Informationen hervorgehoben. 
                <h7 class="bold mt-3 mb-3">Datentypen</h7>
                ...
                <h7 class="bold mt-3 mb-3">Zeitliche Abdeckung</h7>
                Falls Datums-/Zeitspalten im Asset vorhanden sind, wird hier der in den Daten abgedeckte Zeitraum angegeben.
                <h7 class="bold mt-3 mb-3">Zeitliche Konsistenz</h7>
                Falls Datums-/Zeitspalten im Asset vorhanden sind, wird hier die niedrigste, lückenlos vorhandene Zeiteinheit hervorgehoben. Detailliertere Informationen sind im zugehörigen, gleichnamigen Tab zu finden. 
                <h7 class="bold mt-3 mb-3">Anzahl der Spalten</h7>
                Hier findet sich die Anzahl aller im Asset enthaltenen Spalten.
                <h7 class="bold mt-3 mb-3">Anzahl der Zeilen</h7>
                Hier findet sich die Anzahl aller im Asset enthaltenen Zeilen.
                <h7 class="bold mt-3 mb-3">Top 3 numerische Verteilungen</h7>
                ...
                <h7 class="bold mt-3 mb-3">String-Werteverteilung</h7>
                ...
                <h7 class="bold mt-3 mb-3">Numerische Korrelationsanalyse</h7>
                ...
                <h7 class="bold mt-3 mb-3">Numerische Anomalieanalyse</h7>
                ...
                <h7 class="bold mt-3 mb-3">Daten-Saisonalität</h7>
                Aktuell befindet sich diese Auswertung im Umbau.
                <h6 class="bold mb-5">Tab: Attributliste</h6>
                ...
                <h6 class="bold mb-5">Tab: Vollständigkeit</h6>
                Die Tabelle zur Attributvollständigkeit gibt zu jeder im Asset enthaltenen Spalte an, ob und wie viele Werte fehlen.
                <h6 class="bold mb-5">Tab: Zeitliche Konsistenz</h6>
                Die Tabelle zur zeitlichen Konsistenz liefert für alle im Asset enthaltenen Datums-/Zeitspalten Angaben zur Lückenlosigkeit je Zeiteinheit. 
                <h6 class="bold mb-5">Tab: Numerische Werteverteilung</h6> 
                ...
                <p>Geprüft wird dabei auf die folgenden Verteilungen: </p>
                <ul>
                    <li>Cauchy</li>
                    <li>Exponpow</li>
                    <li>Gamma</li>
                ...
                <h6 class="bold mb-5">Tab: String-Werteverteilung</h6>
                ...
                <h6 class="bold mb-5">Tab: Numerische Korrelationsanalyse</h6> 
                ...
                <h6 class="bold mb-5">Tab: Numerische Anomalie-Analyse</h6>
                ...
                <h6 class="bold mb-5">Tab: Daten-Saisonalität</h6> 
                ...
                <h5 class="bold mb-5">Zusätzliche Analysen für semi-strukturierte Texte</h5>
                <h6 class="bold mb-5">Tab: Asset Struktur</h6>
                ...
                <h6 class="bold mb-5">Tab: Schema</h6>
                Dieser Tab bietet eine Übersicht über das Schema des Assets.
                <h5 class="bold mb-5">Zusätzliche Analysen für unstrukturierte Texte</h5>
                <h6 class="bold mb-5">Tab: Unstrukturierter Text</h6>
                Dieser Tab bietet eine Übersicht mit den folgenden Details: 
                <ul>
                    <li>Sprachen</li>
                    <li>Anzahl Zeilen</li>
                ...
                <h6 class="bold mb-5">Tab: Eingebettete Tabellen</h6>
                Falls vorhanden, bietet dieser Tab weitere Details zu den im Dokument enthaltenen Tabellen.
                <h5 class="bold mb-5">Zusätzliche Analysen für Bilder</h5>
                <h6 class="bold mb-5">Tab: Bild</h6>
                Dieser Tab bietet eine Übersicht mit den folgenden Details: 
                <ul>
                ...
                <h5 class="bold mb-5">Zusätzliche Analysen für Videos - ab 14.04.2025</h5>
                <h6 class="bold mb-5">Tab: Video</h6>
                Details hierzu folgen.
                <h5 class="bold mb-5">Zusätzliche Analysen für Audiodaten - ab 14.04.2025</h5>
                <h6 class="bold mb-5">Tab: Audio</h6>
                Details hierzu folgen.
                </div>
            `
    }
