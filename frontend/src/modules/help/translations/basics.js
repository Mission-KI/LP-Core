const basicsHelpText = {
    ...
    de: {
        fullContent:
            `
            <div class="col-md-10">
                <h4 class="bold mt-4">Motivation</h4>
                ...
                <h5 class="bold mt-4">Zielgruppe Datennutzer</h5>
                ...
                <h6 class="bold mt-4">Vorteile für den Datennutzer</h6>
                <ul>
                ...
                <h5 class="bold mt-4">Zielgruppe Datenanbieter</h5>
                ...
                <h6 class="bold mt-4">Vorteile für den Datenanbieter</h6>
                <ul>
...
Kunden ziehen gut strukturierte und interpretierbare Daten vor, da diese ihnen wertvolle Einblicke bieten [<a href="/help#formats">mehr zu den umfangreichen Analysen</a>].</li>
                ...
                <h5 class="bold mt-4">Zielgruppe Betreiber</h5>
                ...
                <h6 class="bold mt-4">Vorteile für den Betreiber</h6>
                <ul>
                ...
                <h4 class="bold mt-4">Begrifflichkeiten kurz erklärt</h4>
                <h5 class="bold mt-4">Was ist ein Asset?</h5>
                Ein Asset (“Data Asset“) bezeichnet ein im Datenraum oder Datenportal bereitgestelltes Datenangebot. 
                <h5 class="bold mt-4">Was ist ein Datensatz?</h5>
                ...
                <h5 class="bold mt-4">Was ist ein EDP?</h5>
                ...
                <h5 class="bold mt-4" id="dataspace-dataportal">Was ist ein Datenraum bzw ein Datenportal?</h5>
                <h6 class="bold mt-4" id="dataspace">Datenraum</h6>
                ...
                <h6 class="bold mt-4" id="dataportal">Datenportal</h6>
