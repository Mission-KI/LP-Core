const functionsHelpText = {
    ...
    de: {
        fullContent:
            `
            <div class="col-md-10">
            <h4 class="bold mt-4" id="landingpage">Landing Page</h4>
            ...
            <h4 class="bold mt-4" id="search">Suche</h4>
            ...
            <h5 class="bold mt-4">Freitext Suche (einfach)</h5>
            ...
            <h5 class="bold mt-4">Suche im Expertenmodus (Query Language)</h5>
            ...
            <h6 class="bold mt-4" id="query-language">Hilfestellungen zur Query Language</h6>
            <ul>
                <li>Zur Suche nach Tags müssen diese in Anführungszeichen gesetzt werden</li>
            </ul>
            Weitere Hilfestellungen folgen in Kürze.
            <h5 class="bold mt-4">Filterbasierte Suche</h5>
            ...
            <h6 class="bold mt-4">Allgemeine Filter</h6>
            <ul>
            ...
            <h6 class="bold mt-4">Strukturierte Daten Filter</h6>
            <ul>
            ...
            <h5 class="bold mt-4">Suchergebnisse</h5>
            ...
            <h6 class="bold mt-4">EDP-Listenansicht</h6>
            ...
            <h6 class="bold mt-4">EDP-Kachelansicht</h6>
            ...
            <h5 class="bold mt-4" id=bookmarks">Lesezeichen</h5>
            ...
            <h4 class="bold mt-4">Funktionen je EDP</h4>
            <h5 class="bold mt-4">Detailansicht</h5>
            <h5 class="bold mt-4" id="get-asset">Datensatz abrufen</h5>
            ...
            <h5 class="bold mt-4">Heller/Dunkler Modus</h5>
            Hier kann der Nutzer zwischen einer hellen und einer dunklen Darstellung wählen.
            <h5 class="bold mt-4">Sucheinstellungen</h5>
            <h6 class="bold mt-4" id="expert-mode">Expertenmodus</h6>
            <h7 class="bold mt-3">So verwenden Sie den Expertenmodus</h7>
            <ul>
            ...
            <h6 class="bold mt-4">Filter immer ausklappen</h6>
