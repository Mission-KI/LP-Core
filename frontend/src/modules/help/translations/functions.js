const functionsHelpText = {
    ...
    de: {
        fullContent:
            `
            <div class="col-md-10">
            <h4 class="bold mb-5" id="landingpage">Landing Page</h4>
            <p>Die Landing Page bietet einen einfachen Einstieg in die Welt von daseen. </p>
            <p>Der Nutzer kann dort zunächst eine Datenkategorie und im zweiten Schritt einen Datenraum oder Datenanbieter wählen, der Daten in dieser Kategorie bereitstellt. Nach dieser Auswahl landet der Nutzer in der entsprechend vorgefilterten Suche.</p>
            <h4 class="bold mb-5" id="search">Suche</h4>
            <p>Sie können auf daseen nach sogenannten Extended Dataset Profiles (EDP) suchen. Ein EDP ist eine standardisierte Metadatenbeschreibung eines von einem Datenanbieter (Data Publisher/Data Provider) direkt oder über ein Datenportal bzw. einen Datenraum (Data Source) angebotenen Datensatzes (Asset). Ein Asset besteht aus einer oder mehreren komprimierten Dateien eines Formates und einer Datenstruktur [<a href="/help#formats">mehr zu Datenformaten und -strukturen</a>].</p>
            <p>daseen verweist dabei in den Suchergebnissen typischerweise immer auf die Data Source, über die das im EDP referenzierte Asset geladen werden kann. Eine Ausnahme bilden die Assets, bei denen die von der Data Source bereitgestellten Metainformationen nur einen direkten Download-Link beinhalten. Für solche Assets verweist der EDP auf den direkten Download-Link des Assets.</p>
            <h5 class="bold mb-5">Freitext Suche (einfach)</h5>
            <p>Sie können daseen durch Eingabe beliebiger Stichwörter in das Suchfeld nach EDP durchsuchen. Der eingegebene Suchbegriff wird dabei gegen folgende Metainformationen abgeglichen und durchsucht: </p>
            <ul>
            ...
            <h5 class="bold mb-5">Suche im Expertenmodus (Query Language)</h5>
            ...
            <p>Standardmäßig ist der Expertenmodus deaktiviert, um den Einstieg in daseen zu erleichtern. Nutzer mit Kenntnissen in der Elasticsearch Query Language können den Modus über die Sucheinstellungen aktivieren [<a href="/help#expert-mode">mehr erfahren</a>].</p>
            <h6 class="bold mb-5" id="query-language">Hilfestellungen zur Query Language</h6>
            <ul>
                <li>Zur Suche nach Tags müssen diese in Anführungszeichen gesetzt werden</li>
            </ul>
            Weitere Hilfestellungen folgen in Kürze.
            <h5 class="bold mb-5">Filterbasierte Suche</h5>
            <p>Neben der Freitext Suche bietet daseen auch eine filterbasierte Suche an. Diese kann entweder alleine oder in Kombination mit der Freitext Suche genutzt werden. Um eine filterbasierte Suche zu starten, klicken Sie unter dem Suchfeld auf “Filter”. Alle Filter sind einer Filterkategorie zugeordnet. Dabei wird zwischen Datenstruktur unabhängigen Filtern (“Allgemeine Filter“) und Datenstruktur spezifischen Filtern unterschieden.</p>
            <p>Sobald ein Filter ausgewählt wurde, wird dieser unterhalb des Freitext Suchfelds als Filtertag angezeigt. Ein Filter kann deaktiviert werden, indem man den Filter wieder abwählt oder auf das “x” im Filtertag klickt. </p>
            <p>Aktuell stehen folgende Filter zur Verfügung:</p>
            <h6 class="bold mb-5">Allgemeine Filter</h6>
            <ul>
            ...
            <h6 class="bold mb-5">Strukturierte Daten Filter</h6>
            <ul>
            ...
            <ul>
                ...
                <li>Erweitertes Menu: Über die drei Punkte am rechten Rand können weitere Aktionen zum EDP ausgelöst werden. Aktuell werden folgende Funktionen unterstützt:
                    <ul>
                        <li>Lesezeichen setzen/Lesezeichen entfernen [<a href="/help#booksmarks">mehr erfahren</a>]</li>
            ...
            <h6 class="bold mb-5">EDP-Kachelansicht</h6>
            ...
            <h5 class="bold mb-5" id=bookmarks">Lesezeichen</h5>
            <p>Über Klick auf „Lesezeichen“ kann ein EDP markiert und in der Lesezeichen Liste gespeichert werden. Ist ein EDP-Eintrag mit einem Lesezeichen markiert, wird dies über ein Stern Icon angezeigt. Alle mit einem Lesezeichen markierten EDP können über die Lesezeichen Seite (siehe Lesezeichen Seite) angezeigt werden. Mit Klick auf Lesezeichen entfernen, kann ein Lesezeichen für einen EDP-Eintrag gelöscht werden. </p>
            <h4 class="bold mb-5">Funktionen je EDP</h4>
            <h5 class="bold mb-5">Detailansicht</h5>
            <h5 class="bold mb-5" id="get-asset">Datensatz abrufen</h5>
            <p>Mit Klick auf Datensatz abrufen, erfolgt eine Weiterleitung (Referal) zu der Download Seite über die das Asset geladen werden kann. Dabei gilt folgendes: </p>
            <ul>
            ...
            <h5 class="bold mb-5">Heller/Dunkler Modus</h5>
            Hier kann der Nutzer zwischen einer hellen und einer dunklen Darstellung wählen.
            <h5 class="bold mb-5">Sucheinstellungen</h5>
            <h6 class="bold mb-5" id="expert-mode">Expertenmodus</h6>
            <h7 class="bold mt-3 mb-3">So verwenden Sie den Expertenmodus</h7>
            <ul>
            ...
            <h7 class="bold mb-3">Was passiert, wenn Sie eine falsche Syntax verwenden?</h7>
            <ul>
            ...
            <h7 class="bold mb-3">Wann sollten Sie den Expertenmodus verwenden?</h7>
            <ul>
            ...
            <h6 class="bold mb-5">Filter immer ausklappen</h6>
            <p>Ist die Option deaktiviert, so können die Filter über den unterhalb des Suchfeldes vorhandenen Filter-Button ein- und ausgeblendet werden.</p>
            <p>Ist die Option aktiviert, so werden die Filter standardmäßig angezeigt.</p>
        </div>
            `
    }
};
