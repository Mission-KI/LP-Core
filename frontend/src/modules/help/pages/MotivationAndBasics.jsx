    ...
    if (currentLanguage === "de") {
        return (
            <div className="col-md-10">
                ...
                <p className="regular text-justify">Über den Link <a href="https://app.daseen.de/" target="_blank">app.daseen.de</a> kann die Suche direkt aufgerufen werden.</p>
                <p className="regular text-justify">Nachfolgende Grafik illustriert die zugrundeliegende Zielarchitektur. </p>
                <img src={target_architecture} alt="Zielarchitektur" className="w-100 my-4" />

                <h5 className="mt-4">Zielgruppen und Anwendungsfälle</h5>
                <p className="regular text-justify">Nachfolgender Absatz beschreibt die unterschiedlichen Zielgruppen und Anwendungsfälle. </p>
                <p className="regular text-justify">Dabei werden folgende drei Benutzergruppen und Hauptanwendungsfälle unterschieden:</p>
                <ul className="regular text-justify">
                ...
                <p className="regular text-justify">Der Datennutzer (“Data User”) ist eine Person, Organisation oder Software, die aktiv nach Daten sucht um diese für das Trainieren eines KI-Modells, eine Datenanalyse oder das Bereitstellen eines anderen Datendienstes zu nutzen.</p>
                ...
                <p className="regular text-justify">Ein Datenanbieter (“Data Publisher“) oder Veröffentlicher ist eine Person, Organisation oder Institution, die Daten in einem Datenraum bereitstellt oder in über ein Datenportal veröffentlicht [<a href="/help#dataspace-dataportal">mehr erfahren</a>].</p>
                <p className="regular text-justify">Bei einer Veröffentlichung über einen Datenraum, ist der Zugriff auf die Daten und den Datenkatalog in der Regel Zugriffsbeschränkt. Der Datenanbieter kontrolliert über die im Datenraum implementierten Sicherheitsmechanismen sowohl den Umfang des Zugriffs sowie die Nutzung der angebotenen Daten durch einen Datennutzer.</p>
                <p className="regular text-justify">daseen und EPDS unterstützen in der aktuellen Version die Integration in EDC und Gaia-X basierte Datenräume.</p>
                <p className="regular text-justify">Im offenen Datenportal veröffentlicht der Datenanbieter die Daten über das Portal, sodass andere Nutzer die Möglichkeit haben, diese zu suchen, anzusehen und abzurufen.</p>
                ...
                <p className="regular text-justify">Ein Betreiber verfügt über geschlossene Datenräume [<a href="/help#dataspace">mehr erfahren</a>] oder offene Datenportale [<a href="/help#dataportal">mehr erfahren</a>].</p>
                ...
                <p className="regular text-justify">Ein erweitertes Datensatzprofil (“Extended Dataset Profile“) verwenden Sie im Kontext von Datenräumen, Datenkatalogen oder Dateninfrastrukturen.</p>
                <p className="regular text-justify">Ein EDP stellt dabei eine maschinenlesbare, umfassende und erweiterbare Beschreibung eines Assets auf Metadatenbasis dar. </p>
                <p className="regular text-justify">Es beinhaltet nicht nur den Namen des Assets und klassische Meta-Informationen wie dessen Ersteller, sondern bietet zudem zahlreiche zusätzliche Informationen, die es ermöglichen, das Asset und die darin enthaltenen Datensätze einfacher zu finden und deren Inhalte besser zu verstehen. Je nach Datenformat der Datensätze werden unterschiedliche Analysen durchgeführt [mehr erfahren].</p>
                <p className="regular text-justify">Welche Informationen sind üblicherweise enthalten?</p>
                <ul className="regular text-justify">
                ...
                <h5 className="mt-4" id="dataportal">Datenportal</h5>
                <p className="regular text-justify">Ein offenes Datenportal (“Data Portal“) ist eine Webseite oder Plattform, die es ermöglicht, Daten zu finden, einzusehen und herunterzuladen. Man kann es sich als eine Art Katalog oder Online-Shop für Daten vorstellen, wobei hier nicht Produkte erworben werden, sondern Informationen und Datensätze gesucht und genutzt werden.</p>
