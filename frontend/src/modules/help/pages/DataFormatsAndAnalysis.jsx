    ...
    return (
      <div className="col-md-10">
        ...
        <p className="regular text-justify">
          ...
          einheitlichen Informationen. Darüber hinaus gibt es zusätzliche
          Analysen und bereitgestellte Informationen je nach Datenformat.
        </p>
        ...
        <p className="regular text-justify">
          Dieses Icon zeigt an, dass auf ein Asset nur nach Registrierung über
          die EDP-Data Source zugegriffen werden kann.{" "}
        </p>
        ...
        <ul className="regular text-justify">
          ...
          <li>
            <span className="fw-500">Processed Data:</span> Der Inhalt des
            Assets wurde nach der Erzeugung ganz oder in Teilen re-definiert,
          ...
          <li>
            <span className="fw-500">AI/ML Result Data:</span> Bei Assets mit
            dem Reifegrad AI/ML Result Data handelt es sich um Daten, die durch
            eine KI bzw. durch einen ML Algorithmus erzeugt wurden.
          </li>
        </ul>
        ...
        <p className="regular text-justify">
          Dieses Icon zeigt an, ob das Asset für AI Training genutzt werden
          darf. Für das AI/KI-Training mit öffentlich bereitgestellten Daten
          (eGov-Daten) werden Lizenzen wie Deutschland 2.0-Zero, PDDL und
          cc-zero empfohlen, da sie die notwendige Analyse und Bearbeitung der
          Daten erlauben, um die KI-Compliance sicherzustellen. Dafür sind
          qualitativ-validierte / kuratierte Daten nötig: Für einfache
          KI-Systeme nach ErwG 27 der KI-VO; bzw. für Hoch-Risiko nach Art. 10
          KI-VO.{" "}
        </p>
        ...
        <ul className="regular text-justify">
          <li>
            <span className="fw-500">EDP Version:</span> Versionsnummer
            innerhalb von daseen. Anhand dieser lässt sich erkennen, wie oft das
            EDP erfolgreich in daseen hochgeladen/geupdated wurde (initiale
            Version: 1).
          </li>
          <li>
        ...
        <p className="regular text-justify">
          Hier wird das Datenformat des EDP bzw. bei geschachtelten Strukturen
          des ausgewählten Elements angezeigt.
        </p>
        ...
        <p className="regular text-justify">
          Unterschieden wird hier zwischen statischen (“static”) und
          inflationären Daten (“inflationary“).
        </p>
        ...
        <p className="regular text-justify">
          Als Ergänzung zum weiter oben angezeigten Volumen, das die
          komprimierte Größe anzeigt, ist an dieser Stelle die Größe des
          entpackten Archivs sichtbar.
        </p>
        ...
        <p className="regular text-justify">
          ...
          einen Klick auf die eingebettete Tabellen und Bilder springt man in
          den jeweiligen Tab, der weitere Details enthält. Über einen Klick auf
          andere eingebetteten Elemente springt man in die jeweilige Detailsicht
        ...
        <p className="regular text-justify">
          ...
          Werte in einer Spalte vom gleichen Typ sind. Falls nicht, kann über
          den entsprechenden Tab in der Detailansicht eingesehen werden, für
          welche Attribute Inkonsistenzen ermittelt wurden.
        </p>
        ...
        <p className="regular text-justify">
          Hier wird je im Asset vorhandenen Typ aus <i>numeric</i>,{" "}
          <i>string</i> und <i>date/time</i> angezeigt, wie viele Spalten dieses
          Typs im Asset enthalten sind. Eine detaillierte Ansicht zu den
          einzelnen Spalten ist im Tab Attributliste zu finden.
        </p>
        <p className="fw-500 regular mt-3">Zeitliche Abdeckung</p>
        <p className="regular text-justify">
          Falls Datums-/Zeitspalten im Asset vorhanden sind, wird hier der in
          den Daten abgedeckte Zeitraum angegeben.
        </p>
        ...
        <p className="regular text-justify">
          ...
          komplett (“all”) oder überwiegend (“many”) homogen oder herogen
          verteilt sind. Detaillierte Angaben sind im zugehörigen Tab zu finden.
        </p>
        ...
        <p className="regular text-justify">
          ...
          numerischen Attributen in einem Asset sind im zugehörigen Tab zu
          finden. In der Data Science Info wird darüber zur vereinfachten Suche
          und Filterung eine Zusammenfassung gebildet:
        </p>
        <ul className="regular text-justify">
          <li>
            “no correlation”: Es liegt keine solche Korrelation im EDP vor.
          </li>
          <li>
          ...
          <li>
            “strong correlation”: Es liegt mindestens eine solche Korrelation
            vor, die über 0,8 oder unter -0,8 liegt.
          </li>
        </ul>
        <p className="fw-500 regular mt-3">Numerische Anomalieanalyse</p>
        <p className="regular text-justify">
          Zur vereinfachten Suche und Filterung liefert der{" "}
          <i>outlierRelativeCount</i> den durchschnittlicher Anteil der
          Anomalien über Perzentil, zScore und IQR, deren Details im zugehörigen
          Tab einzusehen sind.{" "}
        </p>
        <ul className="regular text-justify">
        ...
        <p className="regular text-justify">
          ...
          unterschiedliche Werte pro Attribut in einem Asset gefunden wurden.
          Die häufigsten in diesem Asset aufgetretenen Werteverteilungen werden
        ...
        <p className="regular text-justify">
          ...
          Unterschieden wird zwischen einer homogenen oder heterogenen
          Verteilung. Eine aufsummierte Angabe zur vorherrschenden
          Werteverteilung im gesamten Asset wird darüber hinaus in der Data
          Science Info hervorgehoben.
        </p>
        <h6 className="bold mt-4">Tab: Numerische Korrelationsanalyse</h6>
        <p className="regular text-justify">
          Dieser Tab enthält eine Grafik zur paarweisen Bestimmung von
          Korrelationen zwischen numerischen Attributen in einem Asset. Eine
          rosa Färbung bedeutet eine starke positive Korrelation, die Werte
          beider Attribute bewegen sich in gleicher Richtung. Bei einer blauen
          Färbung liegt eine stark negative Korrelation vor, die Werte der
          Attribute bewegen sich in entgegengesetzte Richtungen. Bei einer
          grauen Färbung liegt keine bzw. kaum eine Korrelation vor.
        </p>
        ...
        <p className="regular text-justify">
          ...
          (Perzentil-basiert, Z-Score und Inter-Quartile-Range). Die Liste
          liefert die statistischen, quantisierten Anomalie-Verteilungen pro
          Verfahren sowie die Anzahl der ermittelten Anomalien pro Attribut in
          einem Asset.
        </p>
        ...
        <p className="regular text-justify">
          ...
          semi-strukturierter Text kann eine beliebige Anzahl strukturierter
          Texte enthalten. Über einen Klick auf eines dieser eingebetteten
        ...
        <p className="regular text-justify">
          ...
          <ul className="regular text-justify">
            ...
            <li>
              geringer Kontrast (lowContrast) - hier wird zwischen false und
              true unterschieden
            </li>
            <li>elaScore</li>
          </ul>
