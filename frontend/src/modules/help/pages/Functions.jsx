  ...
  if (currentLanguage === "de") {
    return (
      <div className="col-md-10">
        ...
        <p className="regular text-justify">
          Der Nutzer kann dort zunächst eine Datenkategorie und im zweiten
          Schritt einen Datenraum oder Datenanbieter wählen, der Daten in dieser
          Kategorie bereitstellt. Nach dieser Auswahl landet der Nutzer in der
          entsprechend vorgefilterten Suche.
        </p>
        ...
        <p className="regular text-justify">
          ...
          suchen. Ein EDP ist eine standardisierte Metadatenbeschreibung eines
          von einem Datenanbieter (Data Publisher/Data Provider) direkt oder
        ...
        <p className="regular text-justify">
          ...
          die Data Source, über die das im EDP referenzierte Asset geladen
          werden kann. Eine Ausnahme bilden die Assets, bei denen die von der
          Data Source bereitgestellten Metainformationen nur einen direkten
          Download-Link beinhalten. Für solche Assets verweist der EDP auf den
          direkten Download-Link des Assets.
        </p>
        ...
        <p className="regular text-justify">
          ...
          Sucherlebnis verbessert, indem sie Autovervollständigungsvorschläge
          für das Schreiben natürlicher Sprachabfragen in Elasticsearch bietet.
        ...
        <ul className="regular">
          ...
          <li>
            Publisher: Über die Drop-Down Liste können ein oder mehrere
            Publisher die Daten in einem Datenraum/Datenportal veröffentlichen
          ...
          <li>
            Größenbereich: Über die Schieberegler kann eingestellt werden,
            welche minimale und/oder maximale Größe ein Asset haben muss/darf,
            um in die Suche eingeschlossen zu werden. Im Fall von Archiven
            bezieht sich dies auf die komprimierte Größe des Assets.{" "}
          </li>
        </ul>
        ...
        <ul className="regular">
          <li>
            ...
            minimale und/oder maximale Anzahl an Zeilen ein Asset haben
        ...
        <p className="regular text-justify">
          ...
          erhobenen EDP-Metadaten auf daseen gefunden werden. Jeder EDP wird
          dabei als ein EDP-Eintrag in der EDP-Ergebnisliste (EDP-Liste)
          angezeigt. Die Sortierung erfolgt dabei immer nach Vollständigkeit der
          ermittelbaren Metainformationen und der zeitlicher Aktualität der
          Veröffentlichung des EDP. Wurde keine EDP-Suche oder Filterung
          aktiviert, werden alle EDP in der EDP-Liste angezeigt. Pro Seite
          werden maximal 12 EDP-Einträge angezeigt. Ist die EDP-Liste größer,
          kann über eine Blätterfunktion am Seitenende in der EDP-Liste vor- und
          zurück geblättert werden. Neben einer EDP-Listenansicht kann auch eine
          EDP-Kachelansicht gewählt werden. Auch diese enthält maximal 12
          EDP-Einträge pro Seite.{" "}
        </p>
        ...
        <ul className="regular">
          <li>
            ...
            Freitext. Wurde kein EDP-Titel vergeben, wird der Dateiname des
            Assets angezeigt. Klickt man auf den EDP-Titel, gelangt man zur
            EDP-Detailansicht.
          </li>
          <li>
            EDP-Beschreibung: Die Beschreibung ist ein vom Data Publisher
            eingegebener Freitext, zur Beschreibung des Inhalts des Assets.
            Wurde keine EDP-Beschreibung vergeben, ist das Feld leer.
          </li>
          <li>
          ...
          <li>
            ...
            Datenstruktur des Assets an sowie die Dateiendung (in
            Klammern).{" "}
          </li>
          <li>
            EDP Size: Das EDP Size Feld gibt die Dateigröße des Assets an. Falls
            das Asset komprimiert angeboten wird, wird die Größe des
            komprimierten Assets angezeigt.
          </li>
          <li>
            EDP-Lizenz: Das EDP-Lizenz Feld gibt den Namen und falls vorhanden
            die URL zu der Datenlizenz an, unter der das Asset vom
            EDP-Datenanbieter angeboten wird. Wurde keine Datenlizenz angegeben,
            steht das Feld auf None.
          </li>
          <li>
          ...
          <li>
            Erweitertes Menu: Über die drei Punkte am rechten Rand können
            weitere Aktionen zum EDP ausgelöst werden. Aktuell werden folgende
        ...
        <p className="regular text-justify">
          ...
          Lesezeichen markiert, wird dies über ein Stern Icon angezeigt. Alle
          mit einem Lesezeichen markierten EDP können über die Lesezeichen Seite
        ...
        <p className="regular text-justify">
          Mit Klick auf Datensatz abrufen, erfolgt eine Weiterleitung (Referal)
          zu der Download Seite über die das Asset geladen werden kann. Dabei
          gilt folgendes:{" "}
        </p>
        <ul className="regular">
          <li>
            Wurde keine Asset URL der Data Source mitgegeben, sondern nur der
            Download Link des Datenanbieters zum Download des Assets, ist der
            EDP direkt mit der Asset URL verlinkt.{" "}
          </li>
          <li>
          ...
          <li>
            ...
            Closed Access Data Sources der Fall), ist der EDP auf die Standard
            URL der Data Source verlinkt.
          </li>
        </ul>
        <h5 className="mt-4">Schema abrufen</h5>
        Über diesen Button lässt sich die zur Erstellung des EDP genutzte
        Version des EDP Schemas herunterladen.
        ...
        englischen Sprache der Oberfläche gewechselt werden.Einige EDP
        spezifische Inhalte werden auch in der deutschen Variante weiterhin im
        englischen Originalbegriff der Metadaten angezeigt.
        ...
        <ul className="regular">
          ...
          <li>
            ...
            führen, dennoch ist es wichtig, Ihre Syntax vor dem Start der Suche
            zu überprüfen.
          </li>
          <li>
        ...
        <ul className="regular">
          ...
          <li>
            Wenn Sie erweiterte Suchen durchführen, die Filter, Aggregationen
            oder benutzerdefinierte Abfragen erfordern.
          </li>
          <li>
            Wenn Sie eine präzisere und leistungsfähigere Suchfunktion
            benötigen, die über einfache Asset-Namenssuchen hinausgeht.
          </li>
        </ul>
        <h5 className="mt-4">Filter immer ausklappen</h5>
        <p className="regular text-justify">
          Ist die Option deaktiviert, so können die Filter über den unterhalb
          des Suchfeldes vorhandenen Filter-Button ein- und ausgeblendet werden.
        </p>
        <p className="regular text-justify">
          Ist die Option aktiviert, so werden die Filter standardmäßig
          angezeigt.
        </p>
      </div>
    );
