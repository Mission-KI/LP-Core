    ...
    return (
        <div className='m-auto d-block w-100' style={{ maxWidth: 1500, overflowX: 'auto' }}>
            <div className="table-responsive">
                <table id="consistencyTable" className='table table-bordered table-hover'>
                    <thead>
                        <tr>
                            <th className='py-2 w-33'>{t('table.attributes.attribute')}</th>
                            <th className='py-2 w-33'>{t('table.attributes.hasMissingValues')}</th>
                            <th className='py-2 w-33' style={{ textAlign: 'left' }}>{t('table.attributes.countMissingValues')}</th>
                        </tr>
                    </thead>
                    <tbody>
