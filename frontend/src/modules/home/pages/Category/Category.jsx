...
const Category = () => {
    ...
    const [dataSpaces, setDataSpaces] = useState([
        { id: 1, name: "GovData - Das Datenportal für Deutschland", image: autobahn, shortName: "GovData" },
        { id: 2, name: "Autobahn GmbH", image: bast, shortName: "Autobahn" },
        { id: 3, name: "Toll Collect GmbH", image: flugsicherung, shortName: "Toll Collect" },
        { id: 4, name: "Mobility Data Space", image: govdata, shortName: "Mobility" },
        { id: 5, name: "Deutschlands Plattform für Daten, die etwas bewegen", image: mobilithek, shortName: "Deutschlands Plattform für Daten" },
        { id: 6, name: "Deutsche Flugsicherung", image: mobility, shortName: "Deutsche Flugsicherung" },
        { id: 7, name: "Bundesanstalt für Straßenwesen", image: collect, shortName: "Bundesanstalt für Straßenwesen" },
    ]);
