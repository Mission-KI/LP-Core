        ...
        fullContent:
            `
                <div class="col-md-10">
                    ...
                    <ul>
                    <li class="py-2">
                        <span class="fw-500">EDP Quick View:</span> Clicking on this icon opens the EDP Quick View, which contains all the key data science information about an asset (see also EDP Quick View).
                    </li>
                    <li class="py-2">
                        <span class="fw-500">Open Access:</span> This icon indicates that an asset can be accessed via the EDP data source without registration.
                    </li>
                    <li class="py-2">
                        <span class="fw-500">Closed Access:</span> This icon indicates that an asset can only be accessed via the EDP data source after registration.
                    </li>
                    <li class="py-2">
                        <span class="fw-500">Date Time Attribute:</span> This icon shows whether a time specification has been recognized in the asset. If yes, an attempt is made to determine the temporal coverage (from, to) and the frequency of the data points in the asset.
                    </li>
                    <li class="py-2">
                        <span class="fw-500">Temporal Frequency:</span> This icon shows whether a frequency could be determined in which the data points in the asset were generated. If so, the system checks whether there are any gaps and if so, how many.
                    </li>
                    <li class="py-2">
                        <span class="fw-500">Data Type Consistency:</span> This icon shows whether all values in a column of a structured text data asset are of the same type. If not, the EDP Detail View (see EDP Detail View) can be used to see for which attributes inconsistencies have been determined.
                    </li>
                    <li class="py-2">
                        <span class="fw-500">Attribute Consistency:</span> This icon shows whether a value exists for each column and row in a structured text data asset. If not, the EDP Detail View (see EDP Detail View) can be used to see how many values have been determined for each column and row.
                    </li>
                    <li class="py-2">
                        <span class="fw-500">Significant Variance:</span> This icon indicates whether a significant variance was found in the asset data. If so, the asset is examined for different distributions. The results are documented in graphical and tabular form in the EDP Detail View (see EDP Detail View).
                    </li>
                    <li class="py-2">
                        <span class="fw-500">Geo Location Attribute:</span> This icon indicates whether an asset contains geolocation information.
                    </li>
                    <li class="py-2">
                        <span class="fw-500">Personal Data:</span> This icon indicates whether an asset contains personal data. If so, the order data agreement provided by the data provider is linked, if available.
                    </li>
                    <li class="py-2">
                        <span class="fw-500">Asset processing status:</span> The asset processing status indicates the degree of data maturity. A distinction is made between the following states:
