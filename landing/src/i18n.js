      ...
      en: {
        translation: {
          ...
          categories: {
            ...
            noItems:
              "Unfortunately there is no data available for this category yet.",
          ...
          publishers: {
            bast: {
              ...
              description:
                "The research institute BASt, which is part of the Federal Ministry of Transport, provides data on the safety, environmental compatibility, economic efficiency and performance of Germany's roads.",
            },
            tollcollect: {
              title: "Toll Collect GmbH",
              description:
                "Toll Collect GmbH offers data in the context of the German truck toll system.",
            },
            autobahn: {
              title: "Autobahn GmbH",
              description:
                "The Autobahn GmbH of the Federal Government offers data in the context of planning, construction, operation, traffic management, maintenance, financing and asset management of highways and trunk roads in Germany. ",
            },
            pangaea: {
              title:
                "PANGAEA - Data Publisher for Earth & Environmental Science",
              description:
                "PANGAEA is a member of the World Data System and offers services for the archiving, publication and dissemination of georeferenced data from Earth system research.",
            },
          },
          dataSpaces: {
            govdata: {
              ...
              description:
                "The GovData portal offers transparent, open and freely accessible data from all levels of government.",
            },
            mobility: {
              title: "Data Sharing Community for mobility pioneers",
              description:
                "The Mobility Data Space is the fair data sharing community for everyone who wants to exchange data from the mobility sector.",
            },
            mobilithek: {
              title: "Germany's platform for data that drives things forward",
              description:
                "The platform Mobilithek offers access to open mobility data and is a national access point for mobility data.",
            },
            geoportal: {
              title: "Geodata from federal, state and local authorities",
              description:
                "Via this portal interested users can search, find and use publicly available geodata from federal, state and local authorities.",
            },
            konstanz: {
      ...
      de: {
        translation: {
          ...
          categories: {
            ...
            noItems:
              "Es sind leider noch keine Daten für diese Kategorie vorhanden.",
          ...
          publishers: {
            bast: {
              ...
              description:
                "Die Forschungseinrichtung BASt im Ressort des Bundesverkehrsministeriums bietet Daten im Kontext Sicherheit, Umweltverträglichkeit, Wirtschaftlichkeit und Leistungsfähigkeit der bundesdeutschen Straßen an.",
            },
            tollcollect: {
              title: "Toll Collect GmbH",
              description:
                "Die Toll Collect GmbH bietet Daten im Kontext des deutschen LKW-Mautsystems an.",
            },
            autobahn: {
              title: "Autobahn GmbH",
              description:
                "Die Autobahn GmbH des Bundes bietet Daten im Kontext Planung, Bau, Betrieb, Verkehrsmanagement, Erhalt, Finanzierung und vermögensmäßige Verwaltung der Autobahnen und Fernstraßen in Deutschland an.",
            },
            pangaea: {
              title:
                "PANGAEA - Datenanbieter für Geo- und Umweltwissenschaften",
              description:
                "PANGAEA ist Mitglied des World Data Systems und bietet Dienste zur Archivierung, Veröffentlichung und Verbreitung von georeferenzierten Daten aus der Erdsystemforschung an.",
            },
          },
          dataSpaces: {
            govdata: {
              ...
              description:
                "Das Portal GovData bietet Daten aller Verwaltungsebenen transparent, offen und frei zugänglich an.",
            },
            mobility: {
              title: "Data Sharing Community für Mobilitätspioniere",
              description:
                "Der Mobility Data Space ist die faire Data Sharing Community für alle, die Daten aus dem Mobilitätssektor miteinander austauschen wollen.",
            },
            mobilithek: {
              title: "Deutschlands Plattform für Daten, die etwas bewegen",
              description:
                "Die Plattform Mobilithek bietet Zugang zu offenen Mobilitätsdaten (open data) und ist nationaler Zugangspunkt für Mobilitätsdaten.",
            },
            geoportal: {
              title: "Geodaten von Bund, Ländern und Kommunen",
              description:
                "Über das Portal können interessierte Nutzende öffentlich bereitgestellte Geodaten von Bund, Ländern und Kommunen über das Geoportal.de suchen, finden und nutzen.",
            },
            konstanz: {
